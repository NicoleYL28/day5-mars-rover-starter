...
class DemoTest {
    @Test
    void should_move_when_executeCommand_given_M_direction_is_N() {
        //Given
    ...
    @Test
    void should_move_when_executeCommand_given_M_when_direction_is_E() {
        //Given
    ...
    @Test
    void should_move_when_executeCommand_given_M_when_direction_is_S() {
        //Given
    ...
    @Test
    void should_turn_left_when_executeCommand_given_L_when_direction_is_N() {
        //Given
        Location location = new Location(0, 0, Direction.N);
        MarsRover marsRover = new MarsRover(location);
    ...
    @Test
    void should_turn_left_when_executeCommand_given_L_when_direction_is_E() {
        //Given
        Location location = new Location(0, 0, Direction.E);
        MarsRover marsRover = new MarsRover(location);
    ...
    @Test
    void should_turn_left_when_executeCommand_given_L_when_direction_is_S() {
        //Given
        Location location = new Location(0, 0, Direction.S);
        MarsRover marsRover = new MarsRover(location);
    ...
    @Test
    void should_turn_left_when_executeCommand_given_L_when_direction_is_W() {
        //Given
        Location location = new Location(0, 0, Direction.W);
        MarsRover marsRover = new MarsRover(location);
    ...
    @Test
    void should_turn_right_when_executeCommand_given_R_when_direction_is_N() {
        //Given
        Location location = new Location(0, 0, Direction.N);
        MarsRover marsRover = new MarsRover(location);
    ...
    @Test
    void should_turn_right_when_executeCommand_given_R_when_direction_is_E() {
        //Given
        Location location = new Location(0, 0, Direction.E);
        MarsRover marsRover = new MarsRover(location);
    ...
    @Test
    void should_turn_right_when_executeCommand_given_R_when_direction_is_S() {
        //Given
        Location location = new Location(0, 0, Direction.S);
        MarsRover marsRover = new MarsRover(location);
    ...
    @Test
    void should_turn_right_when_executeCommand_given_R_when_direction_is_W() {
        //Given
        Location location = new Location(0, 0, Direction.W);
        MarsRover marsRover = new MarsRover(location);
    ...
    @Test
    void should_move_back_when_executeCommand_given_B_direction_is_N() {
        //Given
        Location location = new Location(0, 0, Direction.N);
        MarsRover marsRover = new MarsRover(location);
    ...
    @Test
    void should_move_back_when_executeCommand_given_B_direction_is_E() {
        //Given
        Location location = new Location(0, 0, Direction.E);
        MarsRover marsRover = new MarsRover(location);
    ...
    @Test
    void should_move_back_when_executeCommand_given_B_direction_is_S() {
        //Given
        Location location = new Location(0, 0, Direction.S);
        MarsRover marsRover = new MarsRover(location);
    ...
    @Test
    void should_move_back_when_executeCommand_given_B_direction_is_W() {
        //Given
        Location location = new Location(0, 0, Direction.W);
        MarsRover marsRover = new MarsRover(location);
